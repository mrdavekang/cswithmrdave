(function(root){
  ...
  root.schoolMap = function(detail=false, alternative=false){
    ...
    <g font-family="Arial,sans-serif" font-size="17" fill="#171717">
      ...
      <text x="180" y="84" font-size="14" fill="#a02323">STAFF ONLY — do not enter</text>
      <text x="542" y="131" text-anchor="end">Science Corridor</text>
      <text x="125" y="316" font-size="15">START: face Reception ↑</text>
    </g>
    ...
    <g font-family="Arial,sans-serif" font-size="14" fill="#414141"><text x="24" y="116">Collect timetable</text><text x="311" y="116">Return book</text><text x="578" y="74">FINISH</text></g>
