(function(root){
 ...
 if((c.explain||c.kind==='peer')&&!s.answers[c.id+'Line'])needs.push('line');if(c.kind==='reflect'&&!s.answers.nextAction)needs.push('nextAction');return needs;}
 ...
 const api={key,fresh,workspace,missing,filename};root.Model=api;if(typeof module!=='undefined')module.exports=api;
