-- Step 14: enable Year 11 Week 5 Session 2 after the existing step 13 setup.
...
commit;
select classroom_private.valid_lesson_stage('Year11_week5_session2','fact3') as year11_classroom_ready;
