-- Step 15: enable the three Year 9 Week 5 teacher-led fact pages.
...
commit;
select classroom_private.valid_lesson_stage('year9-week5-theory','fact-boundary') as week5_facts_ready;
